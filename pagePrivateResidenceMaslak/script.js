...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/PRIVATE_RESIDENCE_1453_MASLAK/small_img");
            ...
            newImg.setAttribute("src", "../images/PRIVATE_RESIDENCE_1453_MASLAK/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/PRIVATE_RESIDENCE_1453_MASLAK/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
