...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/STONEBRIDGE_HOTEL/small_img");
            ...
            newImg.setAttribute("src", "../images/STONEBRIDGE_HOTEL/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/STONEBRIDGE_HOTEL/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
