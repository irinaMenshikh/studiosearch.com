...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/SHERATON_ESENYURT/small_img");
            ...
            newImg.setAttribute("src", "../images/SHERATON_ESENYURT/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/SHERATON_ESENYURT/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
