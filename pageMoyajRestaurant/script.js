...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/MOYAJ_RESTAURANT/small_img");
            ...
            newImg.setAttribute("src", "../images/MOYAJ_RESTAURANT/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/MOYAJ_RESTAURANT/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
