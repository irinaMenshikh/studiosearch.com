...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/FAIRMONT_HOTEL_1/small_img");
            ...
            newImg.setAttribute("src", "../images/FAIRMONT_HOTEL_1/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/FAIRMONT_HOTEL_1/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
