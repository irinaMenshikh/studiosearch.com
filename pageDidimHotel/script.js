...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/DIDIM_HOTEL/small_img");
            ...
            newImg.setAttribute("src", "../images/DIDIM_HOTEL/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/DIDIM_HOTEL/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
