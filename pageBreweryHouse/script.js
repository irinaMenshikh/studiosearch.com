...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/BREWERY_HOUSE/small_img");
            ...
            newImg.setAttribute("src", "../images/BREWERY_HOUSE/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/BREWERY_HOUSE/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
