...
if(galleryImage) {
    galleryImage.forEach(function(image, index) {
        image.onclick = function() {
            ...
            let getUrlImgPos = getFullImgUrl.split("/images/PRIVATE_RESIDENCE_ETILER/small_img");
            ...
            newImg.setAttribute("src", "../images/PRIVATE_RESIDENCE_ETILER/" + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute("src", "../images/PRIVATE_RESIDENCE_ETILER/"+ calcNewImg +".jpg");
    newImg.setAttribute("id", "current-img");
